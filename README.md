...
[] Route the 3 remaining nets in pcbnew (audio LPF cluster).
[] Move 4 short traces out of the antenna keep-out zones (RF perf).
[] Reposition silkscreen reference designators that overlap pads.
[] Order Gerbers 
